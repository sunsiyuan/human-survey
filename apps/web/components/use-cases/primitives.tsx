...
export function Section({
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="space-y-4 text-base leading-[1.8] text-stone-800">
        {children}
      </div>
    </section>
  )
...
export function Quote({ children }: { children: ReactNode }) {
  return (
    <blockquote className="rounded-2xl border-l-4 border-[var(--accent)] bg-[var(--surface)] px-5 py-4 font-display text-lg leading-8 text-stone-900">
      {children}
    </blockquote>
  )
}
